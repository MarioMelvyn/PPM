 ...
 void Lectura(iinnttVEC[], iinnttT);
 void Imprime(iinntt  VEC[], iinnttT);                  /* Prototipos de funciones. */
 void  Producto(iinntt*X, iinntt*Y, iinntt  **Z,iinntt  T);    //* Observa que en los
 ...
 /* La función LLeeccttuurraase utiliza para leer un arreglo unidimensional de TT
 ...
 /* La función IImmpprriimmeese utiliza para imprimir un arreglo unidimensional de TT
 ➥elementos de tipo entero. */
 int I;
 {
 for(I=0; I<T; I++)
