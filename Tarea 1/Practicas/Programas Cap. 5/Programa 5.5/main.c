...
const  int TAM = 50;
 ...
 Lectura(CAL, TAM);                           /* Se llama a la función LLeeccttuurraa. */
 Frecuencia(CAL, TAM, FRE, 6);
/* Se llama a la función FFrreeccuueenncciiaa, se pasan ambos arreglos. */
 printf("\nFrecuencia de Calificaciones\n");
 Impresión(FRE, 6);
 Mayor(FRE, 6);
 }
 ...
 /* La función IImmpprreessiióónnse utiliza para imprimir el arreglo de frecuencias. */
 {
 int  I;
 for(I=0; I<T; I++)
 printf("\nVEC[%d]: %d", I, VEC[I]);
