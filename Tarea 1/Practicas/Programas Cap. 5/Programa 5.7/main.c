#include <stdio.h>
 ...
 /* Observa que en el prototipo de EElliimmiinnaa, el segundo parámetro es por
 ➥referencia. Esto, porque el tamaño del arreglo puede disminuir. */

 void main(void)
 {
 int TAM, ARRE[100];
 /* Se escribe un ddoo--wwhhiilleepara verificar que el tamaño del arreglo que se
...
/* Observa que el tamaño del arreglo se pasa por referencia.*/
 ...
 /* La función IImmpprriimmeese utiliza para escribir un arreglo unidimensional, sin
