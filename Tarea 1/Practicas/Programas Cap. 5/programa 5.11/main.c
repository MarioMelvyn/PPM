 ...
 const  int  MAX=100;
 void Lectura(int  in);                                    /* Prototipos de funciones. */
 int  Binaria(iinntt, iinntt,iinntt);
 void main(void)
 {
...
➥arreglo. */
 if(RES)
/* Si RREESStiene un valor verdadero —diferente de 0—, se escribe la
 ...
 ➥elemento EEen el arreglo unidimensional AAde TTelementos. Si se
