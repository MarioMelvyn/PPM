...
if (N > 0)
{
for (I=1; I <= N; I++) /* for en este programa sirve para procesar una serie de números ingresados por el usuario, sumar los números pares e impares por separado y contar el número de números impares.
Al final del bucle, el programa imprime la suma de los números pares y el promedio de los números impares.*/
{
