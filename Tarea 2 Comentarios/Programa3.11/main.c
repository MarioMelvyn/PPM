...
scanf("%f", &CAL);
while (CAL != -1) /* while se utiliza para repetir el proceso de ingresar calificaciones y clasificarlas hasta que el usuario ingrese -1, momento en el cual el bucle se detendrá y
el programa mostrará las estadísticas de clasificación.*/
{
    if (CAL < 4)
    R1++;
else
