...
void main(void)
{
    ...
    scanf("%d", &MAT);
while (MAT) /*se utiliza para crear un ciclo de ejecución que se repetirá mientras una condición específica sea verdadera. En este caso, el bucle while está controlado por la condición MAT,
lo que significa que el bucle continuará ejecutándose mientras MAT sea distinto de cero.*/
{
SUM = 0;
for (I =1; I<= 5; I++)
{
