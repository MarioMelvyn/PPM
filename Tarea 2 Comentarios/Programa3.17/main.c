...
void main(void)
{
    ...
    scanf("%d", &NUM);
for (I = 1; I <= NUM; I++) /* for se utiliza para crear una estructura de repetición controlada que permite realizar una serie de iteraciones con el propósito
de encontrar números perfectos dentro de un rango específico.*/
{
    SUM = 0;
    for (J = 1; J <= (I / 2); J++)
        if ((I % J) == 0)
