...
while (SAL);
/*do-while en este programa se utiliza para seguir solicitando los salarios de los profesores hasta que el usuario ingrese 0, o hasta
que el salario sea 0.*/
