...
while (N < 1 || N > 11);
/* Se utiliza la estructura do-while para verificar que el valor de N sea correcto.do-while se utiliza para validar la entrada del usuario. */
for (I=1; I<=N; I++)
    /* for se utiliza para recopilar y sumar los valores de los lanzamientos individuales.*/
{
